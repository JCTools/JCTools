 ...
 */
abstract class MpscChunkedVarHandleArrayQueueColdProducerFields<E> extends BaseMpscLinkedVarHandleArrayQueue<E> {

    protected final long maxQueueCapacity;

    MpscChunkedVarHandleArrayQueueColdProducerFields(int initialCapacity, int maxCapacity) {
 ...
 */
public class MpscChunkedVarHandleArrayQueue<E> extends MpscChunkedVarHandleArrayQueueColdProducerFields<E> {
    ...
    public MpscChunkedVarHandleArrayQueue(int maxCapacity) {
     ...
     */
    public MpscChunkedVarHandleArrayQueue(int initialCapacity, int maxCapacity) {
