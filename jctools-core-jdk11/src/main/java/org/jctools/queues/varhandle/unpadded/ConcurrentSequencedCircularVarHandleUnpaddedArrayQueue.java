 ...
 */
public abstract class ConcurrentSequencedCircularVarHandleUnpaddedArrayQueue<E> extends ConcurrentCircularVarHandleUnpaddedArrayQueue<E> {

    protected final long[] sequenceBuffer;

    public ConcurrentSequencedCircularVarHandleUnpaddedArrayQueue(int capacity) {
        super(capacity);
