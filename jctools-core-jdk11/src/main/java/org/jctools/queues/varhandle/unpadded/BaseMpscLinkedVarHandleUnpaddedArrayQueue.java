 ...
 */
abstract class BaseMpscLinkedVarHandleUnpaddedArrayQueuePad1<E> extends AbstractQueue<E> implements IndexedQueue {
}
 ...
 * which can found in the jctools-build module. The original source file is BaseMpscLinkedArrayQueue.java.
 */
abstract class BaseMpscLinkedVarHandleUnpaddedArrayQueueProducerFields<E> extends BaseMpscLinkedVarHandleUnpaddedArrayQueuePad1<E> {

    private static final VarHandle VH_PRODUCER_INDEX;

    static {
        try {
            VH_PRODUCER_INDEX = MethodHandles.lookup().findVarHandle(BaseMpscLinkedVarHandleUnpaddedArrayQueueProducerFields.class, "producerIndex", long.class);
        } catch (Exception e) {
 ...
 * which can found in the jctools-build module. The original source file is BaseMpscLinkedArrayQueue.java.
 */
abstract class BaseMpscLinkedVarHandleUnpaddedArrayQueuePad2<E> extends BaseMpscLinkedVarHandleUnpaddedArrayQueueProducerFields<E> {
}
 ...
 * which can found in the jctools-build module. The original source file is BaseMpscLinkedArrayQueue.java.
 */
abstract class BaseMpscLinkedVarHandleUnpaddedArrayQueueConsumerFields<E> extends BaseMpscLinkedVarHandleUnpaddedArrayQueuePad2<E> {

    private static final VarHandle VH_CONSUMER_INDEX;

    static {
        try {
            VH_CONSUMER_INDEX = MethodHandles.lookup().findVarHandle(BaseMpscLinkedVarHandleUnpaddedArrayQueueConsumerFields.class, "consumerIndex", long.class);
        } catch (Exception e) {
            throw new ExceptionInInitializerError(e);
        }
    }
 ...
 * which can found in the jctools-build module. The original source file is BaseMpscLinkedArrayQueue.java.
 */
abstract class BaseMpscLinkedVarHandleUnpaddedArrayQueuePad3<E> extends BaseMpscLinkedVarHandleUnpaddedArrayQueueConsumerFields<E> {
}
 ...
 * which can found in the jctools-build module. The original source file is BaseMpscLinkedArrayQueue.java.
 */
abstract class BaseMpscLinkedVarHandleUnpaddedArrayQueueColdProducerFields<E> extends BaseMpscLinkedVarHandleUnpaddedArrayQueuePad3<E> {

    private static final VarHandle VH_PRODUCER_LIMIT;

    static {
        try {
            VH_PRODUCER_LIMIT = MethodHandles.lookup().findVarHandle(BaseMpscLinkedVarHandleUnpaddedArrayQueueColdProducerFields.class, "producerLimit", long.class);
        } catch (Exception e) {
            throw new ExceptionInInitializerError(e);
        }
    }
 ...
 */
abstract class BaseMpscLinkedVarHandleUnpaddedArrayQueue<E> extends BaseMpscLinkedVarHandleUnpaddedArrayQueueColdProducerFields<E> implements MessagePassingQueue<E>, QueueProgressIndicators {
     ...
     *                        Must be 2 or more.
     */
    public BaseMpscLinkedVarHandleUnpaddedArrayQueue(final int initialCapacity) {
