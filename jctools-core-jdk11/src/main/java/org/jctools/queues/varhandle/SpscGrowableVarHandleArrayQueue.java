 ...
 * @param <E>
 */
public class SpscGrowableVarHandleArrayQueue<E> extends BaseSpscLinkedVarHandleArrayQueue<E> {

    private final int maxQueueCapacity;

    private long lookAheadStep;

    public SpscGrowableVarHandleArrayQueue(final int capacity) {
        this(Math.max(8, Pow2.roundToPowerOfTwo(capacity / 8)), capacity);
    }

    public SpscGrowableVarHandleArrayQueue(final int chunkSize, final int capacity) {
    ...
    @Override
    final boolean offerColdPath(final E[] buffer, final long mask, final long index, final long offset, final E v, final Supplier<? extends E> s) {
