 ...
 * @param <E>
 */
public class SpscChunkedVarHandleUnpaddedArrayQueue<E> extends BaseSpscLinkedVarHandleUnpaddedArrayQueue<E> {

    private final int maxQueueCapacity;

    private long producerQueueLimit;

    public SpscChunkedVarHandleUnpaddedArrayQueue(int capacity) {
        this(Math.max(8, Pow2.roundToPowerOfTwo(capacity / 8)), capacity);
    }

    public SpscChunkedVarHandleUnpaddedArrayQueue(int chunkSize, int capacity) {
