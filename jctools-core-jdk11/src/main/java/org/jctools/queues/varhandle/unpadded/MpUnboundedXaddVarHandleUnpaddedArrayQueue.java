 ...
 * which can found in the jctools-build module. The original source file is MpUnboundedXaddArrayQueue.java.
 */
abstract class MpUnboundedXaddArrayQueueProducerVarHandleUnpaddedChunk<R extends MpUnboundedXaddVarHandleUnpaddedChunk<R, E>, E> extends MpUnboundedXaddVarHandleUnpaddedArrayQueuePad2<E> {

    private static final VarHandle VH_PRODUCER_CHUNK_INDEX;

    static {
        try {
            VH_PRODUCER_CHUNK = MethodHandles.lookup().findVarHandle(MpUnboundedXaddArrayQueueProducerVarHandleUnpaddedChunk.class, "producerChunk", Object.class);
            VH_PRODUCER_CHUNK_INDEX = MethodHandles.lookup().findVarHandle(MpUnboundedXaddArrayQueueProducerVarHandleUnpaddedChunk.class, "producerChunkIndex", long.class);
        } catch (Exception e) {
            throw new ExceptionInInitializerError(e);
        }
    }
 ...
 * which can found in the jctools-build module. The original source file is MpUnboundedXaddArrayQueue.java.
 */
abstract class MpUnboundedXaddVarHandleUnpaddedArrayQueuePad3<R extends MpUnboundedXaddVarHandleUnpaddedChunk<R, E>, E> extends MpUnboundedXaddArrayQueueProducerVarHandleUnpaddedChunk<R, E> {
}
...
abstract class MpUnboundedXaddVarHandleUnpaddedArrayQueueConsumerFields<R extends MpUnboundedXaddVarHandleUnpaddedChunk<R, E>, E> extends MpUnboundedXaddVarHandleUnpaddedArrayQueuePad3<R, E> {
    ...
    static {
        try {
            ...
            VH_CONSUMER_CHUNK = MethodHandles.lookup().findVarHandle(MpUnboundedXaddVarHandleUnpaddedArrayQueueConsumerFields.class, "consumerChunk", Object.class);
        } catch (Exception e) {
            throw new ExceptionInInitializerError(e);
        }
    }
