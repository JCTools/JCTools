...
import static org.jctools.queues.varhandle.unpadded.MpUnboundedXaddVarHandleUnpaddedChunk.NOT_USED;
 ...
 */
abstract class MpUnboundedXaddVarHandleUnpaddedArrayQueuePad1<E> extends AbstractQueue<E> implements IndexedQueue {
}
 ...
 * which can found in the jctools-build module. The original source file is MpUnboundedXaddArrayQueue.java.
 */
abstract class MpUnboundedXaddVarHandleUnpaddedArrayQueueProducerFields<E> extends MpUnboundedXaddVarHandleUnpaddedArrayQueuePad1<E> {

    private static final VarHandle VH_PRODUCER_INDEX;

    static {
        try {
            VH_PRODUCER_INDEX = MethodHandles.lookup().findVarHandle(MpUnboundedXaddVarHandleUnpaddedArrayQueueProducerFields.class, "producerIndex", long.class);
        } catch (Exception e) {
    ...
    final long getAndAddProducerIndex(long delta) {
        return (long) VH_PRODUCER_INDEX.getAndAdd(this, delta);
    }
}
 ...
 * which can found in the jctools-build module. The original source file is MpUnboundedXaddArrayQueue.java.
 */
abstract class MpUnboundedXaddVarHandleUnpaddedArrayQueuePad2<E> extends MpUnboundedXaddVarHandleUnpaddedArrayQueueProducerFields<E> {
}
 ...
 * which can found in the jctools-build module. The original source file is MpUnboundedXaddArrayQueue.java.
 */
abstract class MpUnboundedXaddVarHandleUnpaddedArrayQueueProducerChunk<R extends MpUnboundedXaddVarHandleUnpaddedChunk<R, E>, E> extends MpUnboundedXaddVarHandleUnpaddedArrayQueuePad2<E> {

    private static final VarHandle VH_PRODUCER_CHUNK_INDEX;

    static {
        try {
            VH_PRODUCER_CHUNK = MethodHandles.lookup().findVarHandle(MpUnboundedXaddVarHandleUnpaddedArrayQueueProducerChunk.class, "producerChunk", MpUnboundedXaddVarHandleUnpaddedChunk.class);
            VH_PRODUCER_CHUNK_INDEX = MethodHandles.lookup().findVarHandle(MpUnboundedXaddVarHandleUnpaddedArrayQueueProducerChunk.class, "producerChunkIndex", long.class);
        } catch (Exception e) {
            throw new ExceptionInInitializerError(e);
        }
    }
    ...
    final boolean casProducerChunkIndex(long expected, long value) {
        return VH_PRODUCER_CHUNK_INDEX.compareAndSet(this, expected, value);
    }

    final void soProducerChunkIndex(long value) {
        VH_PRODUCER_CHUNK_INDEX.setRelease(this, value);
    }
 ...
 * which can found in the jctools-build module. The original source file is MpUnboundedXaddArrayQueue.java.
 */
abstract class MpUnboundedXaddVarHandleUnpaddedArrayQueuePad3<R extends MpUnboundedXaddVarHandleUnpaddedChunk<R, E>, E> extends MpUnboundedXaddVarHandleUnpaddedArrayQueueProducerChunk<R, E> {
}
 ...
 * which can found in the jctools-build module. The original source file is MpUnboundedXaddArrayQueue.java.
 */
abstract class MpUnboundedXaddVarHandleUnpaddedArrayQueueConsumerFields<R extends MpUnboundedXaddVarHandleUnpaddedChunk<R, E>, E> extends MpUnboundedXaddVarHandleUnpaddedArrayQueuePad3<R, E> {

    private static final VarHandle VH_CONSUMER_CHUNK;

    static {
        try {
            VH_CONSUMER_INDEX = MethodHandles.lookup().findVarHandle(MpUnboundedXaddVarHandleUnpaddedArrayQueueConsumerFields.class, "consumerIndex", long.class);
            VH_CONSUMER_CHUNK = MethodHandles.lookup().findVarHandle(MpUnboundedXaddVarHandleUnpaddedArrayQueueConsumerFields.class, "consumerChunk", MpUnboundedXaddVarHandleUnpaddedChunk.class);
        } catch (Exception e) {
            throw new ExceptionInInitializerError(e);
        }
    }
    ...
    final void soConsumerChunk(R newValue) {
        VH_CONSUMER_CHUNK.setRelease(this, newValue);
    }
 ...
 * which can found in the jctools-build module. The original source file is MpUnboundedXaddArrayQueue.java.
 */
abstract class MpUnboundedXaddVarHandleUnpaddedArrayQueuePad5<R extends MpUnboundedXaddVarHandleUnpaddedChunk<R, E>, E> extends MpUnboundedXaddVarHandleUnpaddedArrayQueueConsumerFields<R, E> {
}
 ...
 */
abstract class MpUnboundedXaddVarHandleUnpaddedArrayQueue<R extends MpUnboundedXaddVarHandleUnpaddedChunk<R, E>, E> extends MpUnboundedXaddVarHandleUnpaddedArrayQueuePad5<R, E> implements MessagePassingQueue<E>, QueueProgressIndicators {
    ...
    final SpscVarHandleUnpaddedArrayQueue<R> freeChunksPool;
     ...
     */
    MpUnboundedXaddVarHandleUnpaddedArrayQueue(int chunkSize, int maxPooledChunks) {
        ...
        freeChunksPool = new SpscVarHandleUnpaddedArrayQueue<R>(maxPooledChunks);
