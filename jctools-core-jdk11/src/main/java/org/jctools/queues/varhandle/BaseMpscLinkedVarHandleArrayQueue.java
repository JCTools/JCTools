 ...
 */
abstract class BaseMpscLinkedVarHandleArrayQueuePad1<E> extends AbstractQueue<E> implements IndexedQueue {
 ...
 * which can found in the jctools-build module. The original source file is BaseMpscLinkedArrayQueue.java.
 */
abstract class BaseMpscLinkedVarHandleArrayQueueProducerFields<E> extends BaseMpscLinkedVarHandleArrayQueuePad1<E> {

    private static final VarHandle VH_PRODUCER_INDEX;

    static {
        try {
            VH_PRODUCER_INDEX = MethodHandles.lookup().findVarHandle(BaseMpscLinkedVarHandleArrayQueueProducerFields.class, "producerIndex", long.class);
        } catch (Exception e) {
 ...
 * which can found in the jctools-build module. The original source file is BaseMpscLinkedArrayQueue.java.
 */
abstract class BaseMpscLinkedVarHandleArrayQueuePad2<E> extends BaseMpscLinkedVarHandleArrayQueueProducerFields<E> {
    byte b000,b001,b002,b003,b004,b005,b006,b007;//  8b
    byte b010,b011,b012,b013,b014,b015,b016,b017;//  16b
    byte b020,b021,b022,b023,b024,b025,b026,b027;//  24b
    byte b030,b031,b032,b033,b034,b035,b036,b037;//  32b
...
abstract class BaseMpscLinkedVarHandleArrayQueueConsumerFields<E> extends BaseMpscLinkedVarHandleArrayQueuePad2<E> {
    ...
    static {
        try {
            VH_CONSUMER_INDEX = MethodHandles.lookup().findVarHandle(BaseMpscLinkedVarHandleArrayQueueConsumerFields.class, "consumerIndex", long.class);
        } catch (Exception e) {
            throw new ExceptionInInitializerError(e);
        }
    }
 ...
 * which can found in the jctools-build module. The original source file is BaseMpscLinkedArrayQueue.java.
 */
abstract class BaseMpscLinkedVarHandleArrayQueuePad3<E> extends BaseMpscLinkedVarHandleArrayQueueConsumerFields<E> {
    byte b000,b001,b002,b003,b004,b005,b006,b007;//  8b
    byte b010,b011,b012,b013,b014,b015,b016,b017;//  16b
    byte b020,b021,b022,b023,b024,b025,b026,b027;//  24b
    byte b030,b031,b032,b033,b034,b035,b036,b037;//  32b
 ...
 * which can found in the jctools-build module. The original source file is BaseMpscLinkedArrayQueue.java.
 */
abstract class BaseMpscLinkedVarHandleArrayQueueColdProducerFields<E> extends BaseMpscLinkedVarHandleArrayQueuePad3<E> {

    private static final VarHandle VH_PRODUCER_LIMIT;

    static {
        try {
            VH_PRODUCER_LIMIT = MethodHandles.lookup().findVarHandle(BaseMpscLinkedVarHandleArrayQueueColdProducerFields.class, "producerLimit", long.class);
        } catch (Exception e) {
            throw new ExceptionInInitializerError(e);
        }
    }
 ...
 */
abstract class BaseMpscLinkedVarHandleArrayQueue<E> extends BaseMpscLinkedVarHandleArrayQueueColdProducerFields<E> implements MessagePassingQueue<E>, QueueProgressIndicators {
     ...
     *                        Must be 2 or more.
     */
    public BaseMpscLinkedVarHandleArrayQueue(final int initialCapacity) {
