 ...
 */
@InternalAPI
public class MpUnboundedXaddVarHandleChunk<R, E> {

    private static final VarHandle VH_NEXT;

    static {
        try {
            VH_PREV = MethodHandles.lookup().findVarHandle(MpUnboundedXaddVarHandleChunk.class, "prev", Object.class);
            VH_INDEX = MethodHandles.lookup().findVarHandle(MpUnboundedXaddVarHandleChunk.class, "index", long.class);
            VH_NEXT = MethodHandles.lookup().findVarHandle(MpUnboundedXaddVarHandleChunk.class, "next", Object.class);
        } catch (Exception e) {
    ...
    protected MpUnboundedXaddVarHandleChunk(long index, R prev, int size, boolean pooled) {
