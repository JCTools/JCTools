 ...
 */
abstract class SpscVarHandleUnpaddedArrayQueueColdField<E> extends VarHandleReferenceArrayQueue<E> {

    final int lookAheadStep;

    SpscVarHandleUnpaddedArrayQueueColdField(int capacity) {
        super(capacity);
 ...
 * which can found in the jctools-build module. The original source file is SpscArrayQueue.java.
 */
abstract class SpscVarHandleUnpaddedArrayQueueProducerIndexFields<E> extends SpscVarHandleUnpaddedArrayQueueL1Pad<E> {

    private static final VarHandle VH_PRODUCER_INDEX;

    static {
        try {
            VH_PRODUCER_INDEX = MethodHandles.lookup().findVarHandle(SpscVarHandleUnpaddedArrayQueueProducerIndexFields.class, "producerIndex", long.class);
        } catch (Exception e) {
    ...
    SpscVarHandleUnpaddedArrayQueueProducerIndexFields(int capacity) {
        super(capacity);
    }
...
abstract class SpscVarHandleUnpaddedArrayQueueConsumerIndexField<E> extends SpscVarHandleUnpaddedArrayQueueL2Pad<E> {
    ...
    static {
        try {
            VH_CONSUMER_INDEX = MethodHandles.lookup().findVarHandle(SpscVarHandleUnpaddedArrayQueueConsumerIndexField.class, "consumerIndex", long.class);
        } catch (Exception e) {
            throw new ExceptionInInitializerError(e);
        }
    }
 ...
 * which can found in the jctools-build module. The original source file is SpscArrayQueue.java.
 */
abstract class SpscVarHandleUnpaddedArrayQueueL3Pad<E> extends SpscVarHandleUnpaddedArrayQueueConsumerIndexField<E> {

    SpscVarHandleUnpaddedArrayQueueL3Pad(int capacity) {
        super(capacity);
    }
}
 ...
 */
public class SpscVarHandleUnpaddedArrayQueue<E> extends SpscVarHandleUnpaddedArrayQueueL3Pad<E> {

    public SpscVarHandleUnpaddedArrayQueue(final int capacity) {
