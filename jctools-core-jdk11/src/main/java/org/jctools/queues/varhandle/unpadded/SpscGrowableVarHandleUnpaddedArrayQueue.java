...
public class SpscGrowableVarHandleUnpaddedArrayQueue<E> extends BaseSpscLinkedVarHandleUnpaddedArrayQueue<E> {
    ...
    public SpscGrowableVarHandleUnpaddedArrayQueue(final int capacity) {
        this(Math.max(8, Pow2.roundToPowerOfTwo(capacity / 8)), capacity);
    }

    public SpscGrowableVarHandleUnpaddedArrayQueue(final int chunkSize, final int capacity) {
