 ...
 */
public class MpscLinkedVarHandleUnpaddedQueue<E> extends BaseLinkedVarHandleUnpaddedQueue<E> {

    public MpscLinkedVarHandleUnpaddedQueue() {
        LinkedQueueVarHandleNode<E> node = newNode();
        spConsumerNode(node);
    ...
    public boolean offer(final E e) {
        ...
        final LinkedQueueVarHandleNode<E> nextNode = newNode(e);
    ...
    public boolean remove(Object o) {
        ...
        final LinkedQueueVarHandleNode<E> originalConsumerNode = lpConsumerNode();
        LinkedQueueVarHandleNode<E> prevConsumerNode = originalConsumerNode;
        LinkedQueueVarHandleNode<E> currConsumerNode = getNextConsumerNode(originalConsumerNode);
        while (currConsumerNode != null) {
            if (o.equals(currConsumerNode.lpValue())) {
                LinkedQueueVarHandleNode<E> nextNode = getNextConsumerNode(currConsumerNode);
    ...
    public int fill(Supplier<E> s, int limit) {
        ...
        if (limit == 0)
            return 0;
        LinkedQueueVarHandleNode<E> tail = newNode(s.get());
        final LinkedQueueVarHandleNode<E> head = tail;
        for (int i = 1; i < limit; i++) {
            final LinkedQueueVarHandleNode<E> temp = newNode(s.get());
            // spNext: xchgProducerNode ensures correct construction
            tail.spNext(temp);
            tail = temp;
        }
        final LinkedQueueVarHandleNode<E> oldPNode = xchgProducerNode(tail);
    ...
    private LinkedQueueVarHandleNode<E> getNextConsumerNode(LinkedQueueVarHandleNode<E> currConsumerNode) {
