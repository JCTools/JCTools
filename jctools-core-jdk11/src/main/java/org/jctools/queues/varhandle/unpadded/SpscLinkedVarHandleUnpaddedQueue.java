 ...
 * @author nitsanw
 */
public class SpscLinkedVarHandleUnpaddedQueue<E> extends BaseLinkedVarHandleUnpaddedQueue<E> {

    public SpscLinkedVarHandleUnpaddedQueue() {
    ...
    public boolean offer(final E e) {
        ...
        LinkedQueueVarHandleNode<E> oldNode = lpProducerNode();
    ...
    public int fill(Supplier<E> s, int limit) {
        ...
        final LinkedQueueVarHandleNode<E> oldPNode = lpProducerNode();
        soProducerNode(tail);
