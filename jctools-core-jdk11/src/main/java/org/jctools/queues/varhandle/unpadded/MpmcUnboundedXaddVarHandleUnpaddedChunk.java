 ...
 */
@InternalAPI
public final class MpmcUnboundedXaddVarHandleUnpaddedChunk<E> extends MpUnboundedXaddVarHandleUnpaddedChunk<MpmcUnboundedXaddVarHandleUnpaddedChunk<E>, E>
{
    private final long[] sequence;

    public MpmcUnboundedXaddVarHandleUnpaddedChunk(long index, MpmcUnboundedXaddVarHandleUnpaddedChunk<E> prev, int size, boolean pooled)
    {
