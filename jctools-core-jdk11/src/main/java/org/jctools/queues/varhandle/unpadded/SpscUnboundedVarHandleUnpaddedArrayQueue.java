 ...
 * @param <E>
 */
public class SpscUnboundedVarHandleUnpaddedArrayQueue<E> extends BaseSpscLinkedVarHandleUnpaddedArrayQueue<E> {

    public SpscUnboundedVarHandleUnpaddedArrayQueue(int chunkSize) {
