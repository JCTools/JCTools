 ...
 */
abstract class ConcurrentCircularVarHandleUnpaddedArrayQueueL0Pad<E> extends AbstractQueue<E> {
}
 ...
 */
abstract class ConcurrentCircularVarHandleUnpaddedArrayQueue<E> extends ConcurrentCircularVarHandleUnpaddedArrayQueueL0Pad<E> implements MessagePassingQueue<E>, IndexedQueue, QueueProgressIndicators, SupportsIterator {

    protected final long mask;

    protected final E[] buffer;

    ConcurrentCircularVarHandleUnpaddedArrayQueue(int capacity) {
