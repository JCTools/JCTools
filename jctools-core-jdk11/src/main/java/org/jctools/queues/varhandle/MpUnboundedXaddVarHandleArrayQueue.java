...
import static org.jctools.queues.varhandle.MpUnboundedXaddVarHandleChunk.NOT_USED;
import java.lang.invoke.MethodHandles;
import java.lang.invoke.VarHandle;
import org.jctools.queues.*;
import static org.jctools.queues.varhandle.VarHandleQueueUtil.*;
import org.jctools.queues.varhandle.unpadded.SpscVarHandleUnpaddedArrayQueue;
 ...
 */
abstract class MpUnboundedXaddVarHandleArrayQueuePad1<E> extends AbstractQueue<E> implements IndexedQueue {
 ...
 * which can found in the jctools-build module. The original source file is MpUnboundedXaddArrayQueue.java.
 */
abstract class MpUnboundedXaddVarHandleArrayQueueProducerFields<E> extends MpUnboundedXaddVarHandleArrayQueuePad1<E> {

    private static final VarHandle VH_PRODUCER_INDEX;

    static {
        try {
            VH_PRODUCER_INDEX = MethodHandles.lookup().findVarHandle(MpUnboundedXaddVarHandleArrayQueueProducerFields.class, "producerIndex", long.class);
        } catch (Exception e) {
...
MpUnboundedXaddVarHandleArrayQueuePad2<E> extends MpUnboundedXaddVarHandleArrayQueueProducerFields<E> {
    byte b000,b001,b002,b003,b004,b005,b006,b007;//  8b
    byte b010,b011,b012,b013,b014,b015,b016,b017;//  16b
    byte b020,b021,b022,b023,b024,b025,b026,b027;//  24b
    byte b030,b031,b032,b033,b034,b035,b036,b037;//  32b
 ...
 * which can found in the jctools-build module. The original source file is MpUnboundedXaddArrayQueue.java.
 */
abstract class MpUnboundedXaddVarHandleArrayQueueProducerChunk<R extends MpUnboundedXaddVarHandleChunk<R, E>, E> extends MpUnboundedXaddVarHandleArrayQueuePad2<E> {

    private static final VarHandle VH_PRODUCER_CHUNK_INDEX;

    static {
        try {
            VH_PRODUCER_CHUNK = MethodHandles.lookup().findVarHandle(MpUnboundedXaddVarHandleArrayQueueProducerChunk.class, "producerChunk", MpUnboundedXaddVarHandleChunk.class);
            VH_PRODUCER_CHUNK_INDEX = MethodHandles.lookup().findVarHandle(MpUnboundedXaddVarHandleArrayQueueProducerChunk.class, "producerChunkIndex", long.class);
        } catch (Exception e) {
            throw new ExceptionInInitializerError(e);
        }
    }
 ...
 */
abstract class // byte b170,b171,b172,b173,b174,b175,b176,b177;//128b
MpUnboundedXaddVarHandleArrayQueuePad3<R extends MpUnboundedXaddVarHandleChunk<R, E>, E> extends MpUnboundedXaddVarHandleArrayQueueProducerChunk<R, E> {
    byte b000,b001,b002,b003,b004,b005,b006,b007;//  8b
    byte b010,b011,b012,b013,b014,b015,b016,b017;//  16b
    byte b020,b021,b022,b023,b024,b025,b026,b027;//  24b
    byte b030,b031,b032,b033,b034,b035,b036,b037;//  32b
 ...
 * which can found in the jctools-build module. The original source file is MpUnboundedXaddArrayQueue.java.
 */
abstract class MpUnboundedXaddVarHandleArrayQueueConsumerFields<R extends MpUnboundedXaddVarHandleChunk<R, E>, E> extends MpUnboundedXaddVarHandleArrayQueuePad3<R, E> {

    private static final VarHandle VH_CONSUMER_CHUNK;

    static {
        try {
            VH_CONSUMER_INDEX = MethodHandles.lookup().findVarHandle(MpUnboundedXaddVarHandleArrayQueueConsumerFields.class, "consumerIndex", long.class);
            VH_CONSUMER_CHUNK = MethodHandles.lookup().findVarHandle(MpUnboundedXaddVarHandleArrayQueueConsumerFields.class, "consumerChunk", MpUnboundedXaddVarHandleChunk.class);
        } catch (Exception e) {
            throw new ExceptionInInitializerError(e);
        }
    }
 ...
 */
abstract class // byte b170,b171,b172,b173,b174,b175,b176,b177;//128b
MpUnboundedXaddVarHandleArrayQueuePad5<R extends MpUnboundedXaddVarHandleChunk<R, E>, E> extends MpUnboundedXaddVarHandleArrayQueueConsumerFields<R, E> {
    byte b000,b001,b002,b003,b004,b005,b006,b007;//  8b
    byte b010,b011,b012,b013,b014,b015,b016,b017;//  16b
    byte b020,b021,b022,b023,b024,b025,b026,b027;//  24b
    byte b030,b031,b032,b033,b034,b035,b036,b037;//  32b
 ...
 */
abstract class MpUnboundedXaddVarHandleArrayQueue<R extends MpUnboundedXaddVarHandleChunk<R, E>, E> extends MpUnboundedXaddVarHandleArrayQueuePad5<R, E> implements MessagePassingQueue<E>, QueueProgressIndicators {
     ...
     */
    MpUnboundedXaddVarHandleArrayQueue(int chunkSize, int maxPooledChunks) {
