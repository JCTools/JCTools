 ...
 * which can found in the jctools-build module. The original source file is MpUnboundedXaddArrayQueue.java.
 */
abstract class MpUnboundedXaddArrayQueueProducerVarHandleChunk<R extends MpUnboundedXaddVarHandleChunk<R, E>, E> extends MpUnboundedXaddVarHandleArrayQueuePad2<E> {

    private static final VarHandle VH_PRODUCER_CHUNK_INDEX;

    static {
        try {
            VH_PRODUCER_CHUNK = MethodHandles.lookup().findVarHandle(MpUnboundedXaddArrayQueueProducerVarHandleChunk.class, "producerChunk", Object.class);
            VH_PRODUCER_CHUNK_INDEX = MethodHandles.lookup().findVarHandle(MpUnboundedXaddArrayQueueProducerVarHandleChunk.class, "producerChunkIndex", long.class);
        } catch (Exception e) {
            throw new ExceptionInInitializerError(e);
        }
    }
 ...
 */
abstract class // byte b170,b171,b172,b173,b174,b175,b176,b177;//128b
MpUnboundedXaddVarHandleArrayQueuePad3<R extends MpUnboundedXaddVarHandleChunk<R, E>, E> extends MpUnboundedXaddArrayQueueProducerVarHandleChunk<R, E> {
    byte b000,b001,b002,b003,b004,b005,b006,b007;//  8b
    byte b010,b011,b012,b013,b014,b015,b016,b017;//  16b
    byte b020,b021,b022,b023,b024,b025,b026,b027;//  24b
    byte b030,b031,b032,b033,b034,b035,b036,b037;//  32b
...
abstract class MpUnboundedXaddVarHandleArrayQueueConsumerFields<R extends MpUnboundedXaddVarHandleChunk<R, E>, E> extends MpUnboundedXaddVarHandleArrayQueuePad3<R, E> {
    ...
    static {
        try {
            ...
            VH_CONSUMER_CHUNK = MethodHandles.lookup().findVarHandle(MpUnboundedXaddVarHandleArrayQueueConsumerFields.class, "consumerChunk", Object.class);
        } catch (Exception e) {
            throw new ExceptionInInitializerError(e);
        }
    }
