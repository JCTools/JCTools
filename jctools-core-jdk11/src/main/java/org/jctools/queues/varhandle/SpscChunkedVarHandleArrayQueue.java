 ...
 * @param <E>
 */
public class SpscChunkedVarHandleArrayQueue<E> extends BaseSpscLinkedVarHandleArrayQueue<E> {

    private final int maxQueueCapacity;

    private long producerQueueLimit;

    public SpscChunkedVarHandleArrayQueue(int capacity) {
        this(Math.max(8, Pow2.roundToPowerOfTwo(capacity / 8)), capacity);
    }

    public SpscChunkedVarHandleArrayQueue(int chunkSize, int capacity) {
