...
BaseSpscLinkedVarHandleArrayQueuePrePad<E> extends AbstractQueue<E> implements IndexedQueue {
 ...
 * which can found in the jctools-build module. The original source file is BaseSpscLinkedArrayQueue.java.
 */
abstract class BaseSpscLinkedVarHandleArrayQueueConsumerColdFields<E> extends BaseSpscLinkedVarHandleArrayQueuePrePad<E> {
 ...
 * which can found in the jctools-build module. The original source file is BaseSpscLinkedArrayQueue.java.
 */
abstract class BaseSpscLinkedVarHandleArrayQueueConsumerField<E> extends BaseSpscLinkedVarHandleArrayQueueConsumerColdFields<E> {

    private static final VarHandle VH_CONSUMER_INDEX;

    static {
        try {
            VH_CONSUMER_INDEX = MethodHandles.lookup().findVarHandle(BaseSpscLinkedVarHandleArrayQueueConsumerField.class, "consumerIndex", long.class);
        } catch (Exception e) {
 ...
 * which can found in the jctools-build module. The original source file is BaseSpscLinkedArrayQueue.java.
 */
abstract class BaseSpscLinkedVarHandleArrayQueueL2Pad<E> extends BaseSpscLinkedVarHandleArrayQueueConsumerField<E> {
    byte b000,b001,b002,b003,b004,b005,b006,b007;//  8b
    byte b010,b011,b012,b013,b014,b015,b016,b017;//  16b
    byte b020,b021,b022,b023,b024,b025,b026,b027;//  24b
    byte b030,b031,b032,b033,b034,b035,b036,b037;//  32b
 ...
 * which can found in the jctools-build module. The original source file is BaseSpscLinkedArrayQueue.java.
 */
abstract class BaseSpscLinkedVarHandleArrayQueueProducerFields<E> extends BaseSpscLinkedVarHandleArrayQueueL2Pad<E> {

    private static final VarHandle VH_PRODUCER_INDEX;

    static {
        try {
            VH_PRODUCER_INDEX = MethodHandles.lookup().findVarHandle(BaseSpscLinkedVarHandleArrayQueueProducerFields.class, "producerIndex", long.class);
        } catch (Exception e) {
            throw new ExceptionInInitializerError(e);
        }
    }
 ...
 * which can found in the jctools-build module. The original source file is BaseSpscLinkedArrayQueue.java.
 */
abstract class BaseSpscLinkedVarHandleArrayQueueProducerColdFields<E> extends BaseSpscLinkedVarHandleArrayQueueProducerFields<E> {
 ...
 * which can found in the jctools-build module. The original source file is BaseSpscLinkedArrayQueue.java.
 */
abstract class BaseSpscLinkedVarHandleArrayQueue<E> extends BaseSpscLinkedVarHandleArrayQueueProducerColdFields<E> implements MessagePassingQueue<E>, QueueProgressIndicators {
