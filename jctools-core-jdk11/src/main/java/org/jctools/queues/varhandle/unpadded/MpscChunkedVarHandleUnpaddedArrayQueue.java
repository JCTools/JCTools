 ...
 */
abstract class MpscChunkedVarHandleUnpaddedArrayQueueColdProducerFields<E> extends BaseMpscLinkedVarHandleUnpaddedArrayQueue<E> {

    protected final long maxQueueCapacity;

    MpscChunkedVarHandleUnpaddedArrayQueueColdProducerFields(int initialCapacity, int maxCapacity) {
...
public class MpscChunkedVarHandleUnpaddedArrayQueue<E> extends MpscChunkedVarHandleUnpaddedArrayQueueColdProducerFields<E> {
     ...
     */
    public MpscChunkedVarHandleUnpaddedArrayQueue(int initialCapacity, int maxCapacity) {
