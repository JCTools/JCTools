...
public class MpqSanityTestMpscUnboundedXaddVarHandle extends MpqSanityTest
{
    public MpqSanityTestMpscUnboundedXaddVarHandle(ConcurrentQueueSpec spec, MessagePassingQueue<Integer> queue)
    {
        super(spec, queue);
    }
