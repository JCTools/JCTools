...
public final class PaddedCircularArrayOffsetCalculator {
    ...
    static {
        ...
        final int paddingOffset = REF_BUFFER_PAD << CircularArrayOffsetCalculator.REF_ELEMENT_SHIFT;
    ...
    protected static long calcElementOffset(long index, long mask) {
        return REF_ARRAY_BASE + ((index & mask) << CircularArrayOffsetCalculator.REF_ELEMENT_SHIFT);
    }
}
