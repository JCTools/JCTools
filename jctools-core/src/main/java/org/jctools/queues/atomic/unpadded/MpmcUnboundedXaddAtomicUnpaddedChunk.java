 ...
 */
@InternalAPI
public final class MpmcUnboundedXaddAtomicUnpaddedChunk<E> extends MpUnboundedXaddAtomicUnpaddedChunk<MpmcUnboundedXaddAtomicUnpaddedChunk<E>, E>
{
    private final AtomicLongArray sequence;

    public MpmcUnboundedXaddAtomicUnpaddedChunk(long index, MpmcUnboundedXaddAtomicUnpaddedChunk<E> prev, int size, boolean pooled)
    {
