 ...
 */
abstract class MpscChunkedAtomicUnpaddedArrayQueueColdProducerFields<E> extends BaseMpscLinkedAtomicUnpaddedArrayQueue<E> {

    protected final long maxQueueCapacity;

    MpscChunkedAtomicUnpaddedArrayQueueColdProducerFields(int initialCapacity, int maxCapacity) {
