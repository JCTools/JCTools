...
abstract class MpscBlockingConsumerAtomicUnpaddedArrayQueuePad1<E> extends AbstractQueue<E> implements IndexedQueue {
}
 ...
 * which can found in the jctools-build module. The original source file is MpscBlockingConsumerArrayQueue.java.
 */
abstract class MpscBlockingConsumerAtomicUnpaddedArrayQueueColdProducerFields<E> extends MpscBlockingConsumerAtomicUnpaddedArrayQueuePad1<E> {

    private static final AtomicLongFieldUpdater<MpscBlockingConsumerAtomicUnpaddedArrayQueueColdProducerFields> P_LIMIT_UPDATER = AtomicLongFieldUpdater.newUpdater(MpscBlockingConsumerAtomicUnpaddedArrayQueueColdProducerFields.class, "producerLimit");

    private volatile long producerLimit;

    protected final int producerMask;

    protected final AtomicReferenceArray<E> producerBuffer;

    MpscBlockingConsumerAtomicUnpaddedArrayQueueColdProducerFields(int producerMask, AtomicReferenceArray<E> producerBuffer) {
 ...
 */
@SuppressWarnings("unused")
abstract class MpscBlockingConsumerAtomicUnpaddedArrayQueuePad2<E> extends MpscBlockingConsumerAtomicUnpaddedArrayQueueColdProducerFields<E> {

    MpscBlockingConsumerAtomicUnpaddedArrayQueuePad2(int mask, AtomicReferenceArray<E> buffer) {
        super(mask, buffer);
    }
}
 ...
 * which can found in the jctools-build module. The original source file is MpscBlockingConsumerArrayQueue.java.
 */
abstract class MpscBlockingConsumerAtomicUnpaddedArrayQueueProducerFields<E> extends MpscBlockingConsumerAtomicUnpaddedArrayQueuePad2<E> {

    private static final AtomicLongFieldUpdater<MpscBlockingConsumerAtomicUnpaddedArrayQueueProducerFields> P_INDEX_UPDATER = AtomicLongFieldUpdater.newUpdater(MpscBlockingConsumerAtomicUnpaddedArrayQueueProducerFields.class, "producerIndex");

    private volatile long producerIndex;

    MpscBlockingConsumerAtomicUnpaddedArrayQueueProducerFields(int mask, AtomicReferenceArray<E> buffer) {
        super(mask, buffer);
    }
 ...
 */
@SuppressWarnings("unused")
abstract class MpscBlockingConsumerAtomicUnpaddedArrayQueuePad3<E> extends MpscBlockingConsumerAtomicUnpaddedArrayQueueProducerFields<E> {

    MpscBlockingConsumerAtomicUnpaddedArrayQueuePad3(int mask, AtomicReferenceArray<E> buffer) {
        super(mask, buffer);
    }
}
 ...
 * which can found in the jctools-build module. The original source file is MpscBlockingConsumerArrayQueue.java.
 */
abstract class MpscBlockingConsumerAtomicUnpaddedArrayQueueConsumerFields<E> extends MpscBlockingConsumerAtomicUnpaddedArrayQueuePad3<E> {

    private static final AtomicReferenceFieldUpdater<MpscBlockingConsumerAtomicUnpaddedArrayQueueConsumerFields, Thread> BLOCKED_UPDATER = AtomicReferenceFieldUpdater.newUpdater(MpscBlockingConsumerAtomicUnpaddedArrayQueueConsumerFields.class, Thread.class, "blocked");

    private static final AtomicLongFieldUpdater<MpscBlockingConsumerAtomicUnpaddedArrayQueueConsumerFields> C_INDEX_UPDATER = AtomicLongFieldUpdater.newUpdater(MpscBlockingConsumerAtomicUnpaddedArrayQueueConsumerFields.class, "consumerIndex");
    ...
    protected final AtomicReferenceArray<E> consumerBuffer;

    MpscBlockingConsumerAtomicUnpaddedArrayQueueConsumerFields(int mask, AtomicReferenceArray<E> buffer) {
        super(mask, buffer);
        consumerMask = mask;
    ...
    final void soBlocked(Thread newValue) {
        BLOCKED_UPDATER.lazySet(this, newValue);
    }
}
 ...
 */
@SuppressWarnings("unused")
public class MpscBlockingConsumerAtomicUnpaddedArrayQueue<E> extends MpscBlockingConsumerAtomicUnpaddedArrayQueueConsumerFields<E> implements MessagePassingQueue<E>, QueueProgressIndicators, BlockingQueue<E> {

    public MpscBlockingConsumerAtomicUnpaddedArrayQueue(final int capacity) {
    ...
    private boolean offerAndWakeup(AtomicReferenceArray<E> buffer, int mask, long pIndex, E e) {
        final int offset = modifiedCalcCircularRefElementOffset(pIndex, mask);
    ...
    private E parkUntilNext(AtomicReferenceArray<E> buffer, long cIndex, int offset, long timeoutNs) throws InterruptedException {
        E e;
    ...
    private static <E> E spinWaitForElement(AtomicReferenceArray<E> buffer, int offset) {
        E e;
        do {
