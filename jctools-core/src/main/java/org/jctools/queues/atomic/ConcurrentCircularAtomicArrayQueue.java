 ...
 */
abstract class ConcurrentCircularAtomicArrayQueueL0Pad<E> extends AbstractQueue<E> {
 ...
 */
abstract class ConcurrentCircularAtomicArrayQueue<E> extends ConcurrentCircularAtomicArrayQueueL0Pad<E> implements MessagePassingQueue<E>, IndexedQueue, QueueProgressIndicators, SupportsIterator {

    protected final int mask;

    protected final AtomicReferenceArray<E> buffer;

    ConcurrentCircularAtomicArrayQueue(int capacity) {
