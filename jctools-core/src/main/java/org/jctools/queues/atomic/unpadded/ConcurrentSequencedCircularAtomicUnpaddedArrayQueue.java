 ...
 */
public abstract class ConcurrentSequencedCircularAtomicUnpaddedArrayQueue<E> extends ConcurrentCircularAtomicUnpaddedArrayQueue<E> {

    protected final AtomicLongArray sequenceBuffer;

    public ConcurrentSequencedCircularAtomicUnpaddedArrayQueue(int capacity) {
        super(capacity);
