 ...
 * which can found in the jctools-build module. The original source file is MpUnboundedXaddArrayQueue.java.
 */
abstract class MpUnboundedXaddAtomicUnpaddedArrayQueueProducerChunk<R extends MpUnboundedXaddAtomicUnpaddedChunk<R, E>, E> extends MpUnboundedXaddAtomicUnpaddedArrayQueuePad2<E> {
 ...
 * which can found in the jctools-build module. The original source file is MpUnboundedXaddArrayQueue.java.
 */
abstract class MpUnboundedXaddAtomicUnpaddedArrayQueuePad3<R extends MpUnboundedXaddAtomicUnpaddedChunk<R, E>, E> extends MpUnboundedXaddAtomicUnpaddedArrayQueueProducerChunk<R, E> {
}
 ...
 * which can found in the jctools-build module. The original source file is MpUnboundedXaddArrayQueue.java.
 */
abstract class MpUnboundedXaddAtomicUnpaddedArrayQueueConsumerFields<R extends MpUnboundedXaddAtomicUnpaddedChunk<R, E>, E> extends MpUnboundedXaddAtomicUnpaddedArrayQueuePad3<R, E> {
 ...
 * which can found in the jctools-build module. The original source file is MpUnboundedXaddArrayQueue.java.
 */
abstract class MpUnboundedXaddAtomicUnpaddedArrayQueuePad5<R extends MpUnboundedXaddAtomicUnpaddedChunk<R, E>, E> extends MpUnboundedXaddAtomicUnpaddedArrayQueueConsumerFields<R, E> {
}
 ...
 */
abstract class MpUnboundedXaddAtomicUnpaddedArrayQueue<R extends MpUnboundedXaddAtomicUnpaddedChunk<R, E>, E> extends MpUnboundedXaddAtomicUnpaddedArrayQueuePad5<R, E> implements MessagePassingQueue<E>, QueueProgressIndicators {
