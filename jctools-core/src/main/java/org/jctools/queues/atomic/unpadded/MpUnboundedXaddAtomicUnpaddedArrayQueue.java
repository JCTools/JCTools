 ...
 * which can found in the jctools-build module. The original source file is MpUnboundedXaddArrayQueue.java.
 */
abstract class MpUnboundedXaddArrayQueueProducerAtomicUnpaddedChunk<R extends MpUnboundedXaddAtomicUnpaddedChunk<R, E>, E> extends MpUnboundedXaddAtomicUnpaddedArrayQueuePad2<E> {

    private static final AtomicLongFieldUpdater<MpUnboundedXaddArrayQueueProducerAtomicUnpaddedChunk> P_CHUNK_INDEX_UPDATER = AtomicLongFieldUpdater.newUpdater(MpUnboundedXaddArrayQueueProducerAtomicUnpaddedChunk.class, "producerChunkIndex");

    private static final AtomicReferenceFieldUpdater<MpUnboundedXaddArrayQueueProducerAtomicUnpaddedChunk, Object> P_CHUNK_UPDATER = AtomicReferenceFieldUpdater.newUpdater(MpUnboundedXaddArrayQueueProducerAtomicUnpaddedChunk.class, Object.class, "producerChunk");
 ...
 * which can found in the jctools-build module. The original source file is MpUnboundedXaddArrayQueue.java.
 */
abstract class MpUnboundedXaddAtomicUnpaddedArrayQueuePad3<R extends MpUnboundedXaddAtomicUnpaddedChunk<R, E>, E> extends MpUnboundedXaddArrayQueueProducerAtomicUnpaddedChunk<R, E> {
}
...
abstract class MpUnboundedXaddAtomicUnpaddedArrayQueueConsumerFields<R extends MpUnboundedXaddAtomicUnpaddedChunk<R, E>, E> extends MpUnboundedXaddAtomicUnpaddedArrayQueuePad3<R, E> {
    ...
    private static final AtomicReferenceFieldUpdater<MpUnboundedXaddAtomicUnpaddedArrayQueueConsumerFields, Object> C_CHUNK_UPDATER = AtomicReferenceFieldUpdater.newUpdater(MpUnboundedXaddAtomicUnpaddedArrayQueueConsumerFields.class, Object.class, "consumerChunk");
