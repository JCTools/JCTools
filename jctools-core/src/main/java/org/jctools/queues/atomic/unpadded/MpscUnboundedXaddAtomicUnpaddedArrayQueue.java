 ...
 */
public class MpscUnboundedXaddAtomicUnpaddedArrayQueue<E> extends MpUnboundedXaddAtomicUnpaddedArrayQueue<MpscUnboundedXaddAtomicUnpaddedChunk<E>, E>
{
    /**
     ...
     */
    public MpscUnboundedXaddAtomicUnpaddedArrayQueue(int chunkSize, int maxPooledChunks)
    {
        super(chunkSize, maxPooledChunks);
    }

    public MpscUnboundedXaddAtomicUnpaddedArrayQueue(int chunkSize)
    {
        this(chunkSize, 2);
    }

    @Override
    final MpscUnboundedXaddAtomicUnpaddedChunk<E> newChunk(long index, MpscUnboundedXaddAtomicUnpaddedChunk<E> prev, int chunkSize, boolean pooled)
    {
        return new MpscUnboundedXaddAtomicUnpaddedChunk(index, prev, chunkSize, pooled);
    }
    ...
    public boolean offer(E e)
    {
        ...
        MpscUnboundedXaddAtomicUnpaddedChunk<E> pChunk = lvProducerChunk();
    ...
    private MpscUnboundedXaddAtomicUnpaddedChunk<E> pollNextBuffer(MpscUnboundedXaddAtomicUnpaddedChunk<E> cChunk, long cIndex)
    {
        final MpscUnboundedXaddAtomicUnpaddedChunk<E> next = spinForNextIfNotEmpty(cChunk, cIndex);
    ...
    private MpscUnboundedXaddAtomicUnpaddedChunk<E> spinForNextIfNotEmpty(MpscUnboundedXaddAtomicUnpaddedChunk<E> cChunk, long cIndex)
    {
        MpscUnboundedXaddAtomicUnpaddedChunk<E> next = cChunk.lvNext();
        if (next == null)
        {
    ...
    public E poll()
    {
        ...
        MpscUnboundedXaddAtomicUnpaddedChunk<E> cChunk = this.lvConsumerChunk();
        // start of new chunk?
    ...
    public E peek()
    {
        ...
        MpscUnboundedXaddAtomicUnpaddedChunk<E> cChunk = this.lpConsumerChunk();
        // start of new chunk?
        if (ciChunkOffset == 0 && cIndex != 0)
        {
    ...
    public E relaxedPoll()
    {
        ...
        if (ciChunkOffset == 0 && cIndex != 0)
        {
            final MpscUnboundedXaddAtomicUnpaddedChunk<E> next = cChunk.lvNext();
            if (next == null)
            {
                return null;
            }
    ...
    public int fill(Supplier<E> s, int limit)
    {
        ...
        MpscUnboundedXaddAtomicUnpaddedChunk<E> pChunk = null;
        for (int i = 0; i < limit; i++)
        {
