 ...
 */
abstract class ConcurrentCircularAtomicUnpaddedArrayQueueL0Pad<E> extends AbstractQueue<E> {
}
 ...
 */
abstract class ConcurrentCircularAtomicUnpaddedArrayQueue<E> extends ConcurrentCircularAtomicUnpaddedArrayQueueL0Pad<E> implements MessagePassingQueue<E>, IndexedQueue, QueueProgressIndicators, SupportsIterator {

    protected final int mask;

    protected final AtomicReferenceArray<E> buffer;

    ConcurrentCircularAtomicUnpaddedArrayQueue(int capacity) {
