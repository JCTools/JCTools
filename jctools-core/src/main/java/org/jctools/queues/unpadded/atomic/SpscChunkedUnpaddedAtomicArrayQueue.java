 ...
 * @param <E>
 */
public class SpscChunkedUnpaddedAtomicArrayQueue<E> extends BaseSpscLinkedUnpaddedAtomicArrayQueue<E> {

    private final int maxQueueCapacity;

    private long producerQueueLimit;

    public SpscChunkedUnpaddedAtomicArrayQueue(int capacity) {
        this(Math.max(8, Pow2.roundToPowerOfTwo(capacity / 8)), capacity);
    }

    public SpscChunkedUnpaddedAtomicArrayQueue(int chunkSize, int capacity) {
