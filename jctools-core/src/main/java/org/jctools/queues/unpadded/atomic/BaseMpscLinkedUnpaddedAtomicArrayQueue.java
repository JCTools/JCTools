 ...
 */
abstract class BaseMpscLinkedUnpaddedAtomicArrayQueuePad1<E> extends AbstractQueue<E> implements IndexedQueue {
}
 ...
 * which can found in the jctools-build module. The original source file is BaseMpscLinkedArrayQueue.java.
 */
abstract class BaseMpscLinkedUnpaddedAtomicArrayQueueProducerFields<E> extends BaseMpscLinkedUnpaddedAtomicArrayQueuePad1<E> {

    private static final AtomicLongFieldUpdater<BaseMpscLinkedUnpaddedAtomicArrayQueueProducerFields> P_INDEX_UPDATER = AtomicLongFieldUpdater.newUpdater(BaseMpscLinkedUnpaddedAtomicArrayQueueProducerFields.class, "producerIndex");
 ...
 * which can found in the jctools-build module. The original source file is BaseMpscLinkedArrayQueue.java.
 */
abstract class BaseMpscLinkedUnpaddedAtomicArrayQueuePad2<E> extends BaseMpscLinkedUnpaddedAtomicArrayQueueProducerFields<E> {
}
 ...
 * which can found in the jctools-build module. The original source file is BaseMpscLinkedArrayQueue.java.
 */
abstract class BaseMpscLinkedUnpaddedAtomicArrayQueueConsumerFields<E> extends BaseMpscLinkedUnpaddedAtomicArrayQueuePad2<E> {

    private static final AtomicLongFieldUpdater<BaseMpscLinkedUnpaddedAtomicArrayQueueConsumerFields> C_INDEX_UPDATER = AtomicLongFieldUpdater.newUpdater(BaseMpscLinkedUnpaddedAtomicArrayQueueConsumerFields.class, "consumerIndex");
 ...
 * which can found in the jctools-build module. The original source file is BaseMpscLinkedArrayQueue.java.
 */
abstract class BaseMpscLinkedUnpaddedAtomicArrayQueuePad3<E> extends BaseMpscLinkedUnpaddedAtomicArrayQueueConsumerFields<E> {
}
 ...
 * which can found in the jctools-build module. The original source file is BaseMpscLinkedArrayQueue.java.
 */
abstract class BaseMpscLinkedUnpaddedAtomicArrayQueueColdProducerFields<E> extends BaseMpscLinkedUnpaddedAtomicArrayQueuePad3<E> {

    private static final AtomicLongFieldUpdater<BaseMpscLinkedUnpaddedAtomicArrayQueueColdProducerFields> P_LIMIT_UPDATER = AtomicLongFieldUpdater.newUpdater(BaseMpscLinkedUnpaddedAtomicArrayQueueColdProducerFields.class, "producerLimit");
 ...
 */
abstract class BaseMpscLinkedUnpaddedAtomicArrayQueue<E> extends BaseMpscLinkedUnpaddedAtomicArrayQueueColdProducerFields<E> implements MessagePassingQueue<E>, QueueProgressIndicators {
     ...
     *                        Must be 2 or more.
     */
    public BaseMpscLinkedUnpaddedAtomicArrayQueue(final int initialCapacity) {
