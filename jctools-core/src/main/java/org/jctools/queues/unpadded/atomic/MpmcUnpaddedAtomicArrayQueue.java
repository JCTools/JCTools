 ...
 */
abstract class MpmcUnpaddedAtomicArrayQueueL1Pad<E> extends SequencedAtomicReferenceArrayQueue<E> {

    MpmcUnpaddedAtomicArrayQueueL1Pad(int capacity) {
        super(capacity);
    }
}
 ...
 * which can found in the jctools-build module. The original source file is MpmcArrayQueue.java.
 */
abstract class MpmcUnpaddedAtomicArrayQueueProducerIndexField<E> extends MpmcUnpaddedAtomicArrayQueueL1Pad<E> {

    private static final AtomicLongFieldUpdater<MpmcUnpaddedAtomicArrayQueueProducerIndexField> P_INDEX_UPDATER = AtomicLongFieldUpdater.newUpdater(MpmcUnpaddedAtomicArrayQueueProducerIndexField.class, "producerIndex");

    private volatile long producerIndex;

    MpmcUnpaddedAtomicArrayQueueProducerIndexField(int capacity) {
        super(capacity);
    }
 ...
 * which can found in the jctools-build module. The original source file is MpmcArrayQueue.java.
 */
abstract class MpmcUnpaddedAtomicArrayQueueL2Pad<E> extends MpmcUnpaddedAtomicArrayQueueProducerIndexField<E> {

    MpmcUnpaddedAtomicArrayQueueL2Pad(int capacity) {
        super(capacity);
    }
}
 ...
 * which can found in the jctools-build module. The original source file is MpmcArrayQueue.java.
 */
abstract class MpmcUnpaddedAtomicArrayQueueConsumerIndexField<E> extends MpmcUnpaddedAtomicArrayQueueL2Pad<E> {

    private static final AtomicLongFieldUpdater<MpmcUnpaddedAtomicArrayQueueConsumerIndexField> C_INDEX_UPDATER = AtomicLongFieldUpdater.newUpdater(MpmcUnpaddedAtomicArrayQueueConsumerIndexField.class, "consumerIndex");

    private volatile long consumerIndex;

    MpmcUnpaddedAtomicArrayQueueConsumerIndexField(int capacity) {
        super(capacity);
    }
 ...
 * which can found in the jctools-build module. The original source file is MpmcArrayQueue.java.
 */
abstract class MpmcUnpaddedAtomicArrayQueueL3Pad<E> extends MpmcUnpaddedAtomicArrayQueueConsumerIndexField<E> {

    MpmcUnpaddedAtomicArrayQueueL3Pad(int capacity) {
        super(capacity);
    }
}
 ...
 * </ol>
 */
public class MpmcUnpaddedAtomicArrayQueue<E> extends MpmcUnpaddedAtomicArrayQueueL3Pad<E> {

    public static final int MAX_LOOK_AHEAD_STEP = Integer.getInteger("jctools.mpmc.max.lookahead.step", 4096);

    private final int lookAheadStep;

    public MpmcUnpaddedAtomicArrayQueue(final int capacity) {
