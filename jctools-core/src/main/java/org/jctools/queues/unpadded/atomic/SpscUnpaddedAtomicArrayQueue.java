 ...
 */
abstract class SpscUnpaddedAtomicArrayQueueColdField<E> extends AtomicReferenceArrayQueue<E> {

    final int lookAheadStep;

    SpscUnpaddedAtomicArrayQueueColdField(int capacity) {
        super(capacity);
 ...
 * which can found in the jctools-build module. The original source file is SpscArrayQueue.java.
 */
abstract class SpscUnpaddedAtomicArrayQueueL1Pad<E> extends SpscUnpaddedAtomicArrayQueueColdField<E> {

    SpscUnpaddedAtomicArrayQueueL1Pad(int capacity) {
        super(capacity);
    }
}
 ...
 * which can found in the jctools-build module. The original source file is SpscArrayQueue.java.
 */
abstract class SpscUnpaddedAtomicArrayQueueProducerIndexFields<E> extends SpscUnpaddedAtomicArrayQueueL1Pad<E> {

    private static final AtomicLongFieldUpdater<SpscUnpaddedAtomicArrayQueueProducerIndexFields> P_INDEX_UPDATER = AtomicLongFieldUpdater.newUpdater(SpscUnpaddedAtomicArrayQueueProducerIndexFields.class, "producerIndex");

    private volatile long producerIndex;

    protected long producerLimit;

    SpscUnpaddedAtomicArrayQueueProducerIndexFields(int capacity) {
        super(capacity);
    }
 ...
 * which can found in the jctools-build module. The original source file is SpscArrayQueue.java.
 */
abstract class SpscUnpaddedAtomicArrayQueueL2Pad<E> extends SpscUnpaddedAtomicArrayQueueProducerIndexFields<E> {

    SpscUnpaddedAtomicArrayQueueL2Pad(int capacity) {
        super(capacity);
    }
}
 ...
 * which can found in the jctools-build module. The original source file is SpscArrayQueue.java.
 */
abstract class SpscUnpaddedAtomicArrayQueueConsumerIndexField<E> extends SpscUnpaddedAtomicArrayQueueL2Pad<E> {

    private static final AtomicLongFieldUpdater<SpscUnpaddedAtomicArrayQueueConsumerIndexField> C_INDEX_UPDATER = AtomicLongFieldUpdater.newUpdater(SpscUnpaddedAtomicArrayQueueConsumerIndexField.class, "consumerIndex");

    private volatile long consumerIndex;

    SpscUnpaddedAtomicArrayQueueConsumerIndexField(int capacity) {
        super(capacity);
    }
 ...
 * which can found in the jctools-build module. The original source file is SpscArrayQueue.java.
 */
abstract class SpscUnpaddedAtomicArrayQueueL3Pad<E> extends SpscUnpaddedAtomicArrayQueueConsumerIndexField<E> {

    SpscUnpaddedAtomicArrayQueueL3Pad(int capacity) {
        super(capacity);
    }
}
 ...
 */
public class SpscUnpaddedAtomicArrayQueue<E> extends SpscUnpaddedAtomicArrayQueueL3Pad<E> {

    public SpscUnpaddedAtomicArrayQueue(final int capacity) {
