 ...
 */
public class MpscUnboundedUnpaddedAtomicArrayQueue<E> extends BaseMpscLinkedUnpaddedAtomicArrayQueue<E> {

    public MpscUnboundedUnpaddedAtomicArrayQueue(int chunkSize) {
        super(chunkSize);
    }
