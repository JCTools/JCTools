 ...
 * @param <E>
 */
public class SpscUnboundedUnpaddedAtomicArrayQueue<E> extends BaseSpscLinkedUnpaddedAtomicArrayQueue<E> {

    public SpscUnboundedUnpaddedAtomicArrayQueue(int chunkSize) {
