 ...
 * @param <E>
 */
public class SpscGrowableUnpaddedAtomicArrayQueue<E> extends BaseSpscLinkedUnpaddedAtomicArrayQueue<E> {

    private final int maxQueueCapacity;

    private long lookAheadStep;

    public SpscGrowableUnpaddedAtomicArrayQueue(final int capacity) {
        this(Math.max(8, Pow2.roundToPowerOfTwo(capacity / 8)), capacity);
    }

    public SpscGrowableUnpaddedAtomicArrayQueue(final int chunkSize, final int capacity) {
