...
import static org.jctools.queues.unpadded.MpUnboundedXaddUnpaddedChunk.NOT_USED;
...
abstract class MpUnboundedXaddUnpaddedArrayQueueProducerFields<E> extends MpUnboundedXaddUnpaddedArrayQueuePad1<E> {
    ...
    private final static long P_INDEX_OFFSET = fieldOffset(MpUnboundedXaddUnpaddedArrayQueueProducerFields.class, "producerIndex");
 ...
 * which can found in the jctools-build module. The original source file is MpUnboundedXaddArrayQueue.java.
 */
abstract class MpUnboundedXaddUnpaddedArrayQueueProducerChunk<R extends MpUnboundedXaddUnpaddedChunk<R, E>, E> extends MpUnboundedXaddUnpaddedArrayQueuePad2<E> {

    private static final long P_CHUNK_OFFSET = fieldOffset(MpUnboundedXaddUnpaddedArrayQueueProducerChunk.class, "producerChunk");

    private static final long P_CHUNK_INDEX_OFFSET = fieldOffset(MpUnboundedXaddUnpaddedArrayQueueProducerChunk.class, "producerChunkIndex");
 ...
 * which can found in the jctools-build module. The original source file is MpUnboundedXaddArrayQueue.java.
 */
abstract class MpUnboundedXaddUnpaddedArrayQueuePad3<R extends MpUnboundedXaddUnpaddedChunk<R, E>, E> extends MpUnboundedXaddUnpaddedArrayQueueProducerChunk<R, E> {
}
 ...
 * which can found in the jctools-build module. The original source file is MpUnboundedXaddArrayQueue.java.
 */
abstract class MpUnboundedXaddUnpaddedArrayQueueConsumerFields<R extends MpUnboundedXaddUnpaddedChunk<R, E>, E> extends MpUnboundedXaddUnpaddedArrayQueuePad3<R, E> {

    private final static long C_INDEX_OFFSET = fieldOffset(MpUnboundedXaddUnpaddedArrayQueueConsumerFields.class, "consumerIndex");

    private final static long C_CHUNK_OFFSET = fieldOffset(MpUnboundedXaddUnpaddedArrayQueueConsumerFields.class, "consumerChunk");
 ...
 * which can found in the jctools-build module. The original source file is MpUnboundedXaddArrayQueue.java.
 */
abstract class MpUnboundedXaddUnpaddedArrayQueuePad5<R extends MpUnboundedXaddUnpaddedChunk<R, E>, E> extends MpUnboundedXaddUnpaddedArrayQueueConsumerFields<R, E> {
}
 ...
 */
abstract class MpUnboundedXaddUnpaddedArrayQueue<R extends MpUnboundedXaddUnpaddedChunk<R, E>, E> extends MpUnboundedXaddUnpaddedArrayQueuePad5<R, E> implements MessagePassingQueue<E>, QueueProgressIndicators {
