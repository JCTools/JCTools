 ...
 * which can found in the jctools-build module. The original source file is MpUnboundedXaddArrayQueue.java.
 */
abstract class MpUnboundedXaddArrayQueueProducerUnpaddedChunk<R extends MpUnboundedXaddUnpaddedChunk<R, E>, E> extends MpUnboundedXaddUnpaddedArrayQueuePad2<E> {

    private static final long P_CHUNK_OFFSET = fieldOffset(MpUnboundedXaddArrayQueueProducerUnpaddedChunk.class, "producerChunk");

    private static final long P_CHUNK_INDEX_OFFSET = fieldOffset(MpUnboundedXaddArrayQueueProducerUnpaddedChunk.class, "producerChunkIndex");
 ...
 * which can found in the jctools-build module. The original source file is MpUnboundedXaddArrayQueue.java.
 */
abstract class MpUnboundedXaddUnpaddedArrayQueuePad3<R extends MpUnboundedXaddUnpaddedChunk<R, E>, E> extends MpUnboundedXaddArrayQueueProducerUnpaddedChunk<R, E> {
}
