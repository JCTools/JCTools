 ...
 */
abstract class BaseSpscLinkedUnpaddedAtomicArrayQueuePrePad<E> extends AbstractQueue<E> implements IndexedQueue {
}
 ...
 * which can found in the jctools-build module. The original source file is BaseSpscLinkedArrayQueue.java.
 */
abstract class BaseSpscLinkedUnpaddedAtomicArrayQueueConsumerColdFields<E> extends BaseSpscLinkedUnpaddedAtomicArrayQueuePrePad<E> {
 ...
 * which can found in the jctools-build module. The original source file is BaseSpscLinkedArrayQueue.java.
 */
abstract class BaseSpscLinkedUnpaddedAtomicArrayQueueConsumerField<E> extends BaseSpscLinkedUnpaddedAtomicArrayQueueConsumerColdFields<E> {

    private static final AtomicLongFieldUpdater<BaseSpscLinkedUnpaddedAtomicArrayQueueConsumerField> C_INDEX_UPDATER = AtomicLongFieldUpdater.newUpdater(BaseSpscLinkedUnpaddedAtomicArrayQueueConsumerField.class, "consumerIndex");
 ...
 * which can found in the jctools-build module. The original source file is BaseSpscLinkedArrayQueue.java.
 */
abstract class BaseSpscLinkedUnpaddedAtomicArrayQueueL2Pad<E> extends BaseSpscLinkedUnpaddedAtomicArrayQueueConsumerField<E> {
}
 ...
 * which can found in the jctools-build module. The original source file is BaseSpscLinkedArrayQueue.java.
 */
abstract class BaseSpscLinkedUnpaddedAtomicArrayQueueProducerFields<E> extends BaseSpscLinkedUnpaddedAtomicArrayQueueL2Pad<E> {

    private static final AtomicLongFieldUpdater<BaseSpscLinkedUnpaddedAtomicArrayQueueProducerFields> P_INDEX_UPDATER = AtomicLongFieldUpdater.newUpdater(BaseSpscLinkedUnpaddedAtomicArrayQueueProducerFields.class, "producerIndex");
 ...
 * which can found in the jctools-build module. The original source file is BaseSpscLinkedArrayQueue.java.
 */
abstract class BaseSpscLinkedUnpaddedAtomicArrayQueueProducerColdFields<E> extends BaseSpscLinkedUnpaddedAtomicArrayQueueProducerFields<E> {
 ...
 * which can found in the jctools-build module. The original source file is BaseSpscLinkedArrayQueue.java.
 */
abstract class BaseSpscLinkedUnpaddedAtomicArrayQueue<E> extends BaseSpscLinkedUnpaddedAtomicArrayQueueProducerColdFields<E> implements MessagePassingQueue<E>, QueueProgressIndicators {
