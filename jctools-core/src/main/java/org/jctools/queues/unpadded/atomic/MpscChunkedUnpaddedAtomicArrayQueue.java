 ...
 */
abstract class MpscChunkedUnpaddedAtomicArrayQueueColdProducerFields<E> extends BaseMpscLinkedUnpaddedAtomicArrayQueue<E> {

    protected final long maxQueueCapacity;

    MpscChunkedUnpaddedAtomicArrayQueueColdProducerFields(int initialCapacity, int maxCapacity) {
 ...
 */
public class MpscChunkedUnpaddedAtomicArrayQueue<E> extends MpscChunkedUnpaddedAtomicArrayQueueColdProducerFields<E> {

    public MpscChunkedUnpaddedAtomicArrayQueue(int maxCapacity) {
     ...
     */
    public MpscChunkedUnpaddedAtomicArrayQueue(int initialCapacity, int maxCapacity) {
