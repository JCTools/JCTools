...
public class MpscGrowableMessagePassingQueueSanityTest extends MessagePassingQueueSanityTest {
    ...
    public static Collection<Object[]> parameters() {
        ...
        list.add(makeMpq(0, 1, 4, Ordering.FIFO, new MpscGrowableArrayQueue<>(4)));// MPSC size 1
        list.add(makeMpq(0, 1, SIZE, Ordering.FIFO, new MpscGrowableArrayQueue<>(2, SIZE)));// MPSC size SIZE
        return list;
    }
