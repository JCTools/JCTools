...
public class QueueSanityTestMpscUnboundedArray extends QueueSanityTest
{
    ...
    public static Collection<Object[]> parameters()
    {
        ...
        list.add(makeParams(0, 1, 0, Ordering.FIFO, new MpscUnboundedAtomicUnpaddedArrayQueue<>(2)));// MPSC size 1
        list.add(makeParams(0, 1, 0, Ordering.FIFO, new MpscUnboundedAtomicUnpaddedArrayQueue<>(64)));// MPSC size SIZE
        return list;
    }
}
