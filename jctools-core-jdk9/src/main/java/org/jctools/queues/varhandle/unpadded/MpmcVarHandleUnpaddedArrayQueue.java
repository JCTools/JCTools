 ...
 */
abstract class MpmcVarHandleUnpaddedArrayQueueL1Pad<E> extends SequencedVarHandleReferenceArrayQueue<E> {
...
public class MpmcVarHandleUnpaddedArrayQueue<E> extends MpmcVarHandleUnpaddedArrayQueueL3Pad<E> {
    ...
    private boolean notAvailable(long index, int mask, long[] sBuffer, long expectedSeq) {
        final int seqOffset = calcCircularLongElementOffset(index, mask);
