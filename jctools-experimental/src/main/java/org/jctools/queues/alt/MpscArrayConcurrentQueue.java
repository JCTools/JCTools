...
abstract class MpscArrayConcurrentQueueColdFields<E> extends ConcurrentSequencedCircularArray<E> {
    ...
    public MpscArrayConcurrentQueueColdFields(int capacity) {
        super(capacity);
...
public final class MpscArrayConcurrentQueue<E> extends MpscArrayConcurrentQueueColdFields<E> implements
        ConcurrentQueue<E> {
    // post pad queue fields
    long p00, p01, p02, p03, p04, p05, p06, p07;
    long p10, p11, p12, p13, p14, p15, p16, p17;

    public MpscArrayConcurrentQueue(final int capacity) {
