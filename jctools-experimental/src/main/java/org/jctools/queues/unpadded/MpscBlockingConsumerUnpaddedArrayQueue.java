...
abstract class MpscBlockingConsumerUnpaddedArrayQueuePad1<E> extends AbstractQueue<E> implements IndexedQueue
{
...
{
    private final static long P_LIMIT_OFFSET = fieldOffset(MpscBlockingConsumerUnpaddedArrayQueueColdProducerFields.class,"producerLimit");

    private volatile long producerLimit;
    protected final long producerMask;
    protected final E[] producerBuffer;

    MpscBlockingConsumerUnpaddedArrayQueueColdProducerFields(long producerMask, E[] producerBuffer)
    {
...
@SuppressWarnings("unused")
abstract class MpscBlockingConsumerUnpaddedArrayQueuePad2<E> extends MpscBlockingConsumerUnpaddedArrayQueueColdProducerFields<E>
{

    MpscBlockingConsumerUnpaddedArrayQueuePad2(long mask, E[] buffer)
    {
        super(mask, buffer);
    }
}
...
abstract class MpscBlockingConsumerUnpaddedArrayQueueProducerFields<E> extends MpscBlockingConsumerUnpaddedArrayQueuePad2<E>
{
    ...
    MpscBlockingConsumerUnpaddedArrayQueueProducerFields(long mask, E[] buffer)
    {
        super(mask, buffer);
    }
...
@SuppressWarnings("unused")
abstract class MpscBlockingConsumerUnpaddedArrayQueuePad3<E> extends MpscBlockingConsumerUnpaddedArrayQueueProducerFields<E>
{


    MpscBlockingConsumerUnpaddedArrayQueuePad3(long mask, E[] buffer)
    {
        super(mask, buffer);
    }
}
...
abstract class MpscBlockingConsumerUnpaddedArrayQueueConsumerFields<E> extends MpscBlockingConsumerUnpaddedArrayQueuePad3<E>
{
    ...
    MpscBlockingConsumerUnpaddedArrayQueueConsumerFields(long mask, E[] buffer)
    {
        super(mask, buffer);
        consumerMask = mask;
 ...
 * of the mechanics described in {@link BaseMpscLinkedUnpaddedArrayQueue}, but with the reservation bit used for blocking rather
 * than resizing in this instance.
 */
@SuppressWarnings("unused")
public class MpscBlockingConsumerUnpaddedArrayQueue<E> extends MpscBlockingConsumerUnpaddedArrayQueueConsumerFields<E>
