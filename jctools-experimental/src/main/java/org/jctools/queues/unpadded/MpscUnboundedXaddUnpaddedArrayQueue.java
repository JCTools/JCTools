...
import org.jctools.queues.MpscUnboundedXaddChunk;
import org.jctools.util.PortableJvmInfo;

/**
 * An MPSC array queue which grows unbounded in linked chunks.<br>
 * Differently from {@link MpscUnboundedUnpaddedArrayQueue} it is designed to provide a better scaling when more
 ...
 */
public class MpscUnboundedXaddUnpaddedArrayQueue<E> extends MpUnboundedXaddUnpaddedArrayQueue<MpscUnboundedXaddChunk<E>, E>
{
    /**
     ...
     */
    public MpscUnboundedXaddUnpaddedArrayQueue(int chunkSize, int maxPooledChunks)
    {
        super(chunkSize, maxPooledChunks);
    }

    public MpscUnboundedXaddUnpaddedArrayQueue(int chunkSize)
    {
        this(chunkSize, 2);
    }
