 ...
 * Differently from {@link MpmcUnpaddedArrayQueue} it is designed to provide a better scaling when more
...
public class MpmcUnboundedXaddUnpaddedArrayQueue<E> extends MpUnboundedXaddUnpaddedArrayQueue<MpmcUnboundedXaddChunk<E>, E>
{
     ...
     */
    public MpmcUnboundedXaddUnpaddedArrayQueue(int chunkSize, int maxPooledChunks)
    {
        super(chunkSize, maxPooledChunks);
    }

    public MpmcUnboundedXaddUnpaddedArrayQueue(int chunkSize)
    {
        this(chunkSize, 2);
    }
