...
public class LTQ_PerfTest {
    ...
    long performanceRun(final int runNumber,
                        final LinkedTransferQueue<Integer> queue,
    ...
    public static class Producer implements Runnable {
        ...
        public Producer(LinkedTransferQueue<Integer> queue, int repetitions) {
            this.queue = queue;
    ...
    public static class Consumer implements Runnable {
        ...
        public Consumer(LinkedTransferQueue<Integer> queue, int repetitions) {
            this.queue = queue;
            this.repetitions = repetitions;
        }

        public void run() {
            LinkedTransferQueue<Integer> consumer = this.queue;
            int i = this.repetitions;
