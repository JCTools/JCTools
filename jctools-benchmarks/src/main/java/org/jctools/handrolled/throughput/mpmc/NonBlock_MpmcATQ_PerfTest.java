...
public class NonBlock_MpmcATQ_PerfTest {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        new NonBlock_MpmcATQ_PerfTest().run(REPETITIONS, producers, consumers, warmups, runs, bestRunsToAverage, showStats);
    }
    ...
    long performanceRun(final int runNumber,
        ...
        repetitions = adjusted * producersCount * consumersCount;

        int pRepetitions = repetitions / producersCount;
        int cRepetitions = repetitions / consumersCount;;
