...
public class MpmcArrayQueue_PerfTest {
    ...
    void run(final int repetitions,
        ...
        final MpmcArrayQueue<Integer> queue = new MpmcArrayQueue<Integer>(QUEUE_SIZE);
    ...
    long performanceRun(final int runNumber,
                        final MpmcArrayQueue<Integer> queue,
    ...
    public static class Producer implements Runnable {
        ...
        public Producer(MpmcArrayQueue<Integer> queue, int repetitions) {
            this.queue = queue;
    ...
    public static class Consumer implements Runnable {
        ...
        public Consumer(MpmcArrayQueue<Integer> queue, int repetitions) {
            this.queue = queue;
            this.repetitions = repetitions;
        }

        public void run() {
            MpmcArrayQueue<Integer> consumer = this.queue;
            int i = this.repetitions;
