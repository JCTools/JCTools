...
public class ABQ_PerfTest {
    public static final int REPETITIONS = 50 * 1000 * 100;
    public static final Integer TEST_VALUE = Integer.valueOf(777);

    private static final int producers = 6;
    private static final int consumers = 6;
    ...
    public static void main(final String[] args) throws Exception {
        ...
        new ABQ_PerfTest().run(REPETITIONS, producers, consumers, warmups, runs, bestRunsToAverage, showStats);
    }
    ...
    public static class Producer implements Runnable {
        ...
        public Producer(ArrayBlockingQueue<Integer> queue, int repetitions) {
            this.queue = queue;
        ...
        @Override
        public void run() {
            ArrayBlockingQueue<Integer> producer = this.queue;
    ...
    public static class Consumer implements Runnable {
        ...
        public Consumer(ArrayBlockingQueue<Integer> queue, int repetitions) {
            this.queue = queue;
            this.repetitions = repetitions;
        }

        public void run() {
            ArrayBlockingQueue<Integer> consumer = this.queue;
            int i = this.repetitions;
